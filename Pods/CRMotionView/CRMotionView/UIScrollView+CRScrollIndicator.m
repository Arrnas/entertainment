...
{
    if ([self cr_getBackgroundViewForScrollIndicator] != nil) {
        [[self cr_getBackgroundViewForScrollIndicator] removeFromSuperview];
    }
    if ([self cr_getViewForScrollIndicator] != nil) {
    ...
    CGRect backgroundIndicatorFrame = CGRectMake(self.contentOffset.x + (self.frame.size.width / 2) - (backgroundIndicatorWidth / 2), 0 + CRScrollIndicatorHeight + CRScrollIndicatorBottomSpace, backgroundIndicatorWidth, CRScrollIndicatorHeight);
    ...
    CGRect frame = CGRectMake(self.contentOffset.x + (self.frame.size.width / 2) - (viewScrollIndicatorWidth / 2), 0 + CRScrollIndicatorHeight + CRScrollIndicatorBottomSpace, viewScrollIndicatorWidth, CRScrollIndicatorHeight);
    UIView *viewScrollIndicator = [[UIView alloc] initWithFrame:frame];
    [viewScrollIndicator setBackgroundColor:[[UIColor blueColor] colorWithAlphaComponent:.8f]];
